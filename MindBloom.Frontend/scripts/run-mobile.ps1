...
if (-not $StripePublishableKey) {
    ...
    Write-Warning "Using a placeholder Stripe publishable key. Payment flows need a real pk_test_ key in STRIPE_PUBLISHABLE_KEY or MindBloom.Frontend\.env.local."
}
