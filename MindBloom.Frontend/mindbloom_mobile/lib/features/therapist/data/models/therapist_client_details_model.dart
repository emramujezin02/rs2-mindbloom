...
class TherapistClientDetailsModel {
  ...
  final List<TherapistClientAppointmentModel>
  appointmentHistory;
  ...
  factory TherapistClientDetailsModel.fromJson(
    ...
    final history =
        historyValue is List
            ? historyValue
                ...
                .map(
                  (item) =>
                      TherapistClientAppointmentModel.fromJson(
    ...
    return TherapistClientDetailsModel(
      ...
      pendingAppointments: _toInt(
        json['pendingAppointments'],
      ),
      acceptedAppointments: _toInt(
        json['acceptedAppointments'],
      ),
      completedAppointments: _toInt(
        json['completedAppointments'],
      ),
      cancelledAppointments: _toInt(
        json['cancelledAppointments'],
      ),
      firstAppointmentDate:
          _toNullableDateTime(
            json['firstAppointmentDate'],
          ),
      lastAppointmentDate:
          _toNullableDateTime(
  ...
  static String _readFullName(
    ...
    final firstName =
        _toString(json['firstName']);

    final lastName =
        _toString(json['lastName']);
