...
class TherapistRepository {
  ...
  TherapistRepository({
    required this.therapistApiService,
  });
  ...
  Future<TherapistSearchPageModel> searchTherapists(
    ...
    return therapistApiService.searchTherapists(
      request,
    );
  }

  Future<TherapistDetailsModel> getTherapistById(
    int therapistId,
  ) {
    return therapistApiService.getTherapistById(
      therapistId,
    );
  }
  ...
  Future<TherapistClientDetailsModel>
    ...
    return therapistApiService
        .getTherapistClientDetails(clientId);
  }
  ...
  Future<void> updateTherapistProfile(
    ...
    return therapistApiService
        .updateTherapistProfile(request);
  }

  Future<TherapistProfileImageModel>
      uploadTherapistProfileImage(
    File file,
  ) {
    return therapistApiService
        .uploadTherapistProfileImage(file);
  }

  Future<void> addTherapistAvailability({
    required int therapistId,
    required CreateTherapistAvailabilityRequest
        request,
  }) {
    return therapistApiService
  ...
  Future<void> deleteTherapistAvailability(
    int availabilityId,
  ) {
    return therapistApiService
  ...
  Future<List<TherapistMoodEntryModel>>
      getClientMoodHistory(
    int clientId,
  ) {
    return therapistApiService
        .getClientMoodHistory(clientId);
  }

  Future<TherapistMoodTrendModel>
      getClientMoodTrend(
    int clientId,
  ) {
    return therapistApiService
        .getClientMoodTrend(clientId);
  }

  Future<TherapistMoodTrendModel>
      getClientEmotionalAnalytics({
