...
class PrivateJournalEntryDetailsPage
    extends StatefulWidget {
  final int entryId;

  const PrivateJournalEntryDetailsPage({
    super.key,
    required this.entryId,
  });

  @override
  State<PrivateJournalEntryDetailsPage>
      createState() =>
...
class _PrivateJournalEntryDetailsPageState
    extends State<
        PrivateJournalEntryDetailsPage> {
  ...
  Future<void> _edit() async {
    ...
    final result =
        await Navigator.of(context)
            .pushNamed(
      AppRouter.editPrivateJournalEntry,
      arguments: entry,
    );
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            ...
            'delete this private journal '
            'entry? This action cannot '
            'be undone.',
          ),
          actions: [
            TextButton(
