...
/// Minimum supported logical size of the MindBloom desktop window.
///
/// The value is converted according to the current Windows DPI scaling,
/// so the usable Flutter layout size stays consistent when display scaling
/// is set to 125%, 150%, etc.
...
void Win32Window::SetChildContent(
    HWND content) {
  child_content_ =
      content;
